...
# ===== DURUM =====
banned_users = set()
last_user = {}  # Hangi kullanıcı son mesajı yazdı, direkt ona iletilecek
...
async def target_bot_handler(event):
    if not last_user.get(TARGET_BOT):
        return
    user_id = last_user[TARGET_BOT]
...
async def user_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Son mesajı yazan kullanıcıyı kaydet
    last_user[TARGET_BOT] = user_id
