...
async def target_bot_handler(event):
    ...
    try:
        if event.message.file:
            ...
            await bot_app.bot.send_message(chat_id=user_id, text=event.raw_text)
...
async def main():
    ...
    # Bot ve userbot aynı loop içinde çalışacak
    await bot_app.run_polling(stop_signals=None)

# ===== RAILWAY İÇİN GÜVENLİ START =====
